            ...
            modelBuilder.Entity("AlphaService.Models.Order", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Model = "Kawasaki",
                            Progress = "Active",
                            ServiceDate = new DateTime(2022, 5, 6, 17, 18, 13, 266, DateTimeKind.Local).AddTicks(6091)
                        },
                        new
                        {
                            OrderId = 2,
                            ...
                            Model = "Suzuki",
                            Progress = "Active",
                            ServiceDate = new DateTime(2022, 5, 6, 17, 18, 13, 278, DateTimeKind.Local).AddTicks(7205)
                        },
                        new
                        {
                            OrderId = 3,
                            ...
                            Model = "Kawasaki",
                            Progress = "Canceled",
                            ServiceDate = new DateTime(2022, 5, 6, 17, 18, 13, 278, DateTimeKind.Local).AddTicks(7259)
                        });
                });
            ...
            modelBuilder.Entity("AlphaService.Models.UserOrderRelationship", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserOrderRelationshipId = 1,
                            OrderId = 1,
                            UserId = 1
                        },
                        new
                        {
                            UserOrderRelationshipId = 2,
                            OrderId = 2,
                            UserId = 1
                        },
                        new
                        {
                            UserOrderRelationshipId = 3,
                            OrderId = 3,
                            UserId = 1
                        });
                });
